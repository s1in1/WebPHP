    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="loginBlock">
                ...
                <h1 class="loginBlock_heading">Регистрация</h1>
                ...
                <div class="loginBlock__btn">
                    <button class="loginblock_enterBtn">Создать учетную запись</button>
                    
                </div>                    

                <div class="loginBlock__notif"><p>Есть учетная запись?</p><a href="">Войдите!</a></div>
